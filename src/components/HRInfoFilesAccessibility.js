      ...
      <div className={this.props.className}>
        <Card className="card-container">
          <CardHeader
            ...
            title={
              this.state.file && typeof this.state.file.filename === 'string' ?
                <a href={this.state.file.uri} target="__blank">{this.state.file.filename}</a> : t('files.new_file')}
            className="file-name"
          />
          ...
          <CardActions className="file-container-language">
            {this.state.accessibility && this.state.accessibility.value === t('files.accessibilities.available') ?
              ...
              <input type="file"
                     ...
                     name={'file'}
                     className="none"
                     onChange={ (e) => this.handleChange('file', e.target.file) } />
              <label htmlFor={'file'}>
              ...
              <DropboxChooser
                ...
                success={file => this.handleChange('file', file)}
                multiselect={false}
                extensions={['.pdf']}>
